...
const DetalhesTinto6 = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.wineText}>R$ 93.31</Text>
      <TouchableOpacity onPress={() => navigation.navigate('PedidoVT3')}>
