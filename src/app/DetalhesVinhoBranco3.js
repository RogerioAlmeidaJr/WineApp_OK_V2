...
const DetalhesTintoBranco3 = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.wineText}>R$ 8.241,00</Text>
      <TouchableOpacity onPress={() => navigation.navigate('PedidoVB3')}>
...
export default DetalhesTintoBranco3;