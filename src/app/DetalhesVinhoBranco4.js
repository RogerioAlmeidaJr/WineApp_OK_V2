...
const DetalhesTintoBranco4 = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.wineText}>R$ 5909,99</Text>
      <TouchableOpacity onPress={() => navigation.navigate('PedidoVB4')}>
...
export default DetalhesTintoBranco4;