...
const DetalhesVinhoDessert1 = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.wineText}>R$ 2.300,90</Text>
      <TouchableOpacity onPress={() => navigation.navigate('PedidoVD1')}>
...
export default DetalhesVinhoDessert1;