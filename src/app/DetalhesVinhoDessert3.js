...
const DetalhesVinhoDessert3 = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.wineText}>R$ 54,90</Text>
      <TouchableOpacity onPress={() => navigation.navigate('PedidoVD3')}>
...
export default DetalhesVinhoDessert3;