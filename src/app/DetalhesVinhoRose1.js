...
const DetalhesVinhoRose1 = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.wineText}>R$ 8.174,00</Text>
      <TouchableOpacity onPress={() => navigation.navigate('PedidoVR1')}>
...
export default DetalhesVinhoRose1;