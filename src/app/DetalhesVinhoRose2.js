...
const DetalhesVinhoRose2 = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.wineText}>R$ 598,00</Text>
      <TouchableOpacity onPress={() => navigation.navigate('PedidoVR2')}>
...
export default DetalhesVinhoRose2;