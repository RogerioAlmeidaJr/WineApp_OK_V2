...
const DetalhesVinhoRose3 = ({ navigation }) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.wineText}>R$ 3.460,00</Text>
      <TouchableOpacity onPress={() => navigation.navigate('PedidoVR4')}>
...
export default DetalhesVinhoRose3;